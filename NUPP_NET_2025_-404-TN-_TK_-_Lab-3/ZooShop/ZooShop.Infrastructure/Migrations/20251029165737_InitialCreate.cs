        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_PetProducts_Productes_Id",
                        column: x => x.Id,
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Quantitys = table.Column<int>(type: "integer", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Accessorys_Productes_Id",
                        column: x => x.Id,
                        principalTable: "Productes",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_OrderProductes", x => x.Id);
                    table.ForeignKey(
                        name: "FK_OrderProductes_Productes_ProductId",
                        column: x => x.ProductId,
                        principalTable: "Productes",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_OrderProductes_Orders_OrderId",
                        column: x => x.OrderId,
            ...
            migrationBuilder.InsertData(
                table: "Accessorys",
                columns: new[] { "Id", "Quantitys", "Dressing", "Ingredients", "IsVegetarian" },
                values: new object[,]
                {
            ...
            migrationBuilder.CreateIndex(
                name: "IX_OrderProductes_ProductId",
                table: "OrderProductes",
                column: "ProductId");

            migrationBuilder.CreateIndex(
                name: "IX_OrderProductes_OrderId_ProductId",
                table: "OrderProductes",
